...
#ifndef rotor_gazebo_PLUGINS_GAZEBO_OCTOMAP_PLUGIN_H
#define rotor_gazebo_PLUGINS_GAZEBO_OCTOMAP_PLUGIN_H
...
#include <ros/ros.h>
#include <rotor_gazebo/Octomap.h>
#include <sdf/sdf.hh>
...
class OctomapFromGazeboWorld : public WorldPlugin {
 ...
 protected:
  ...
  void CreateOctomap(const rotor_gazebo::Octomap::Request& msg);
 ...
 private:
  ...
  bool ServiceCallback(rotor_gazebo::Octomap::Request& req, rotor_gazebo::Octomap::Response& res);
};

}

#endif // rotor_gazebo_PLUGINS_GAZEBO_OCTOMAP_PLUGIN_H
