...
#ifndef rotor_gazebo_PLUGINS_CONTROLLER_INTERFACE_H
#define rotor_gazebo_PLUGINS_CONTROLLER_INTERFACE_H
...
class GazeboControllerInterface : public ModelPlugin {
 public:
  GazeboControllerInterface()
      : ModelPlugin(),
        ...
        command_motor_speed_sub_topic_(rotor_gazebo::default_topics::COMMAND_ACTUATORS),
        node_handle_(NULL){}
  ~GazeboControllerInterface();
 ...
 private:
  ...
  void QueueThread();
  void CommandMotorCallback(const rotor_gazebo::ActuatorsConstPtr& input_reference_msg);
};
}

#endif // rotor_gazebo_PLUGINS_CONTROLLER_INTERFACE_H
