...
#include "rotor_gazebo_plugins/gazebo_octomap_plugin.h"
...
bool OctomapFromGazeboWorld::ServiceCallback(rotor_gazebo::Octomap::Request& req,
                                             rotor_gazebo::Octomap::Response& res) {
...
void OctomapFromGazeboWorld::CreateOctomap(const rotor_gazebo::Octomap::Request& msg) {
  const double epsilon = 0.00001;
  const int far_away = 100000;
