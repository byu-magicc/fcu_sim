...
#include <rotor_gazebo/conversions.h>
...
int main(int argc, char** argv) {
  ...
  ros::Publisher wp_pub =
      ...
      rotor_gazebo::default_topics::COMMAND_TRAJECTORY, 10);
  ...
  for (size_t i = 0; i < waypoints.size(); ++i) {
    ...
    rotor_gazebo::EigenTrajectoryPoint trajectory_point;
    ...
    rotor_gazebo::msgMultiDofJointTrajectoryPointFromEigen(trajectory_point, &msg->points[i]);
  }
  wp_pub.publish(msg);
