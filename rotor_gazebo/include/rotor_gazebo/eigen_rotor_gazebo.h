...
#ifndef rotor_gazebo_EIGEN_rotor_gazebo_H
#define rotor_gazebo_EIGEN_rotor_gazebo_H

#include <deque>
#include <Eigen/Eigen>

#include "rotor_gazebo/common.h"

namespace rotor_gazebo {
...
#define rotor_gazebo_CONCATENATE(x, y) x ## y
#define rotor_gazebo_CONCATENATE2(x, y) rotor_gazebo_CONCATENATE(x, y)
#define rotor_gazebo_MAKE_ALIGNED_CONTAINERS(EIGEN_TYPE) \
  typedef std::vector<EIGEN_TYPE, Eigen::aligned_allocator<EIGEN_TYPE> > rotor_gazebo_CONCATENATE2(EIGEN_TYPE, Vector); \
  typedef std::deque<EIGEN_TYPE, Eigen::aligned_allocator<EIGEN_TYPE> > rotor_gazebo_CONCATENATE2(EIGEN_TYPE, Deque); \

rotor_gazebo_MAKE_ALIGNED_CONTAINERS(EigenAttitudeThrust)
rotor_gazebo_MAKE_ALIGNED_CONTAINERS(EigenActuators)
rotor_gazebo_MAKE_ALIGNED_CONTAINERS(EigenRateThrust)
rotor_gazebo_MAKE_ALIGNED_CONTAINERS(EigenTrajectoryPoint)
rotor_gazebo_MAKE_ALIGNED_CONTAINERS(EigenRollPitchYawrateThrust)
rotor_gazebo_MAKE_ALIGNED_CONTAINERS(EigenOdometry)

}

#endif // rotor_gazebo_EIGEN_rotor_gazebo_H
